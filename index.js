...
const collisionsMap = []
// map is 70 tiles wide, and 40 tiles tall
...
// location where image will be placed on canvas
...
function animate() {
    ...
    if (keys.w.pressed || keys.a.pressed || keys.s.pressed || keys.d.pressed) {
        for (let i = 0; i < battleZones.length; i++) {
            ...
            // finding the width of the intersecting rectangle between player and battleZone
            ...
            if (
                ...
                // using half the area of the player, to encourage more battlezones (won't trigger if using whole player)
